...
public class BusOperatorRequest {
	...
	public String toString() {
		return "BusOperatorRequest [id=" + id + ", caseNumber=" + caseNumber + ", busOperatorUsername="
				+ busOperatorUsername + ", requestMsg=" + requestMsg + ", requestFor=" + requestFor + ", status="
				+ status + ", requestDate=" + requestDate + "]";
	}
